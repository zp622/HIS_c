...
namespace HIS_c.Utils
{
    ...
    {
        //public static string connectionString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=127.0.0.1)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=HIS)));User Id=hisuser;Password=hisuser;Min Pool Size=10;Connection Lifetime=120;";
        //public static string connectionString = "User ID=hisuser;Password=hisuser;Data Source=(DESCRIPTION = (ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP)(HOST = 127.0.0.1)(PORT = 1521))) (CONNECT_DATA = (SERVICE_NAME = HIS)))";
        public static string connectionString = ConfigurationManager.ConnectionStrings["OracleConnectionString"].ConnectionString;
        public OracleHelper()
        {
        }
        ...
        /// <returns></returns>
        public static bool readerExists(OracleDataReader dr, string columnName)
        {
